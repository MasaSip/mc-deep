...
class TranslationDataset(Dataset):
    def __init__(self, path, train=None):
        lang1 = 'suomi'
        lang2 = 'rap'
        source_lang_file = os.path.join(path, 'suomi_lang.pkl')
        target_lang_file = os.path.join(path, 'rap_lang.pkl')
        pairs_file = os.path.join(path, 'rap-suomi_pairs_train.pkl')
        train_pairs_file = os.path.join(path, 'rap-suomi_pairs_test.pkl')
        test_pairs_file = os.path.join(path, 'rap-suomi_pairs.pkl')
